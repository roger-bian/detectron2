...
if __name__ == '__main__':
    ...
    def register_dataset():
        register_coco_instances(f"{dataset_name}_train", {}, "E:/toda/training/glove_v3/coco/train_coco/annotations.json", "E:/toda/training/glove_v3/coco/train_coco")
        register_coco_instances(f"{dataset_name}_val", {}, "E:/toda/training/glove_v3/coco/valid_coco/annotations.json", "E:/toda/training/glove_v3/coco/valid_coco")
    ...
    model_file = "E:/detectron2/model/glove_v3_with_valid/config.yaml"

    cfg.merge_from_file(model_file)
    cfg.DATASETS.TRAIN = (f"{dataset_name}_train",)
    cfg.DATASETS.TEST = (f"{dataset_name}_val",)
    cfg.TEST.EVAL_PERIOD = 500 # evaluate validation set after this number of iterations
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.50
    # cfg.DATALOADER.NUM_WORKERS = 2
    cfg.DATALOADER.FILTER_EMPTY_ANNOTATIONS = False
    cfg.MODEL.WEIGHTS = "E:/detectron2/model/glove_v3_with_valid/model_0019999.pth"  # Pre-trained weights
    cfg.SOLVER.IMS_PER_BATCH = BATCH_SIZE
    cfg.SOLVER.BASE_LR = 0.00025  # Learning rate
    cfg.SOLVER.MAX_ITER = NUM_ITERATIONS  # Adjust as needed
    cfg.SOLVER.STEPS = []  # Learning rate decay
    cfg.SOLVER.CHECKPOINT_PERIOD = 500 # save checkpoint after this number of iterations
    ...
    cfg.OUTPUT_DIR = "E:/detectron2/model/glove_v3_with_valid_v2/"
