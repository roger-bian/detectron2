...
if __name__ == '__main__':
    ...
    cfg.TEST.EVAL_PERIOD = 1000 # evaluate validation set after this number of iterations
    ...
    cfg.SOLVER.CHECKPOINT_PERIOD = 1000 # save checkpoint after this number of iterations
    ...
    cfg.OUTPUT_DIR = "E:/detectron2/model/glove_v3_with_valid/"
