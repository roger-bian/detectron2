...
dataset_train = "/home/user/code/roger-bian/detectron2/_data/side_panel/coco/train/_resized" # folder path to training dataset
dataset_valid = "/home/user/code/roger-bian/detectron2/_data/side_panel/coco/val/_resized" # folder path to validation dataset
...
output_dir = "/home/user/code/roger-bian/detectron2/_model/side_panel/v1" # output directory to save model weights
### END OF EDITS ###
