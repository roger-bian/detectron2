...
def register_dataset():
    register_coco_instances(f"{dataset_name}_train", {}, "/mnt/data/data_prashant/face_accessories/COCO/annots/train_annotations.json", "/mnt/data/data_prashant/face_accessories/COCO/train")
    register_coco_instances(f"{dataset_name}_val", {}, "/mnt/data/data_prashant/face_accessories/COCO/annots/val_annotations.json", "/mnt/data/data_prashant/face_accessories/COCO/val")
...
cfg.OUTPUT_DIR = "./Output"+"/"+current_time
