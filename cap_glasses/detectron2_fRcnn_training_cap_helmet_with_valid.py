...
if __name__ == '__main__':
    ...
    dataset_name = "face_accessories"
    def register_dataset():
        register_coco_instances(f"{dataset_name}_train", {}, "E:/paloma/task18/training_data/v2/annotations/train.json", "E:/paloma/task18/training_data/v2/train")
        register_coco_instances(f"{dataset_name}_val", {}, "E:/paloma/task18/training_data/v2/annotations/valid.json", "E:/paloma/task18/training_data/v2/valid")
    ...
    EVAL_AND_SAVE_PERIOD = 500 # evaluate validation set and save checkpoint after this number of iterations
    ...
    cfg.TEST.EVAL_PERIOD = EVAL_AND_SAVE_PERIOD
    ...
    cfg.SOLVER.CHECKPOINT_PERIOD = EVAL_AND_SAVE_PERIOD
    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 128
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = NUM_CLASSES 


    # Output directory to save model weights
    cfg.OUTPUT_DIR = "E:/detectron2/model/face_accessories_v2"
